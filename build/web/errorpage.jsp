...
<html>
    ...
    <body>
        ...
        <div class="container text-center">
            <img src="img/error.png" alt="Error" class="img-fluid" style="width:450px;padding-top:20px; height: 400px;"/>
            <h3 class="display-4">Sorry ! Something went wrong ...</h3>
            <a href="index.jsp"><button class="btn btn-primary text-light btn-lg  mt-3">Home</button></a>
        </div>
